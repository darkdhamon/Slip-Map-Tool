...
Use the repository branching policy in [docs/branching-strategy.md](/C:/GitHub/Slip-Map-Tool/docs/branching-strategy.md). In short:

- `master` is the protected release branch.
- `dev` is the shared integration branch.
- Feature work happens on short-lived branches created from `dev`.
